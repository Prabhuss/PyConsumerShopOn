...
namespace PyConsumerApp.Droid
{
    ...
    [Activity(Label = "Shop On", Icon = "@mipmap/icon", Theme = "@style/MyTheme.Splash", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
